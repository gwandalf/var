...
Some of the first remarkable results with 3D applications were obtained by Lucente et Al. and are reported in \cite{lucente}. They realize basic multimodal interaction, like dragging or resizing of virtual objects. In particular, these two interactions provide a continuous feedback to the user. This is possible thanks to the simplicity of the interactions, where user position regular access is sufficient. Nevertheless, continuous feedback was more difficult to obtain when multimodal interactions became more complex, and the virtual environments more demanding in terms of resources. The framework presented in this report gives a solution to this issue.
